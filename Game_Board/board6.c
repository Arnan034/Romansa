...
void tampilan_champion(){
	gotoxy(61,3); printf("\033[1;33m 1010                          0110 ");
...
void tampilan_good(){
	gotoxy(65,3); printf("\033[1;34m             00011                  ");
...
void tampilan_high_score(){
	int j = 1;
	gotoxy(10,2); printf("\033[1;37m  N O        N I C K N A M E     S C O R E  ");
	for (int i = 3; i <= 23; i++){
		if (i % 2 == 1){
			gotoxy(10,i); printf("+-----+-------------------------+----------+");
		} else {
			if (j != 10){
			gotoxy(10,i); printf("| %d.  |                         |          |", j);
			j++;
			} else {
				gotoxy(10,i); printf("| %d. |                         |          |", j);
			}
