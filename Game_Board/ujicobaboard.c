...
int input1, input2, input3, input4, main_lagi;
input4 = 2;
int z;
z = 1;
char A[7][7];
char pemain1[10], pemain2[10];
...
int main(){
	...
	tampilan_awal();
	if(input1 == 1){
		tampilan_cara_bermain();
		if (input2 == 1){
			tampilan_pilih_board();
			tampilan_nickname();
			do{
			tampilan_game_play();
			tampilan_kemenangan();
...
void tampilan_thankyou(){
	gotoxy(20,2);printf("\033[1;37m101010   10  01     101     101   00   11  10   10    11   101001   01  11");//67
...
void tampilan_papan(){
	...
	for (int i = 3; i <= 17; i++){
		...
		if (i % 2 == 0){
			gotoxy(40,i);printf("|   |   |   |   |   |   |   |", A[l][0], A[l][1], A[l][2], A[l][3], A[l][4], A[l][5], A[l][6]);
			l++;
		}
	}
	printf("\033[0m");
